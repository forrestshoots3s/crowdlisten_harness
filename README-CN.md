...
| **knowledge** | 3 | 项目知识库 |
| **social-listening** | 7 | 搜索社交平台 |
| **audience-analysis** | 6 | AI 分析 |
| **sessions** | 3 | 多智能体协作 |
| **setup** | 5 | 看板管理 |
...
分析工具提供观点聚类、深度分析（受众细分、竞争信号）和研究综合（单条查询生成跨平台报告）。
...
| 工具 | 功能 |
|------|------|
| `analyze_content` | 帖子及评论的情感 + 主题分析（支持 `analysisDepth: "deep"` 进行深度分析） |
...
| 分析工具 | 登录即可 (`npx @crowdlisten/harness login`) | 未登录时不可用 |
